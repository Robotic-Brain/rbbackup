...
runtests() {
    ...
    cat "$TMP/destdir/${TIME[0]}/${TIME[1]}/${TIME[2]}/testing/info.txt" | grep -e '^base:' | grep "'$TMP/destdir/${LASTTIME[0]}/${LASTTIME[1]}/${LASTTIME[2]}/testing'" >/dev/null
    assertEquals "snapshot info: base" 0 $?
